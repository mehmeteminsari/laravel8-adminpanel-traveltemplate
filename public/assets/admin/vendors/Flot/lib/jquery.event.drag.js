...
drag = $special.drag = {
	...
	setup: function( data ){
		...
		if ( this.attachEvent ) this.attachEvent("ondragstart", dontStart ); // prevent images dragging in IE...
		},
	teardown: function(){
		$event.remove( this, "mousedown", handler );
		if ( this === drag.dragging ) drag.dragging = drag.proxy = false; // deactivate element
		selectable( this, true ); // enable text selection
		if ( this.detachEvent ) this.detachEvent("ondragstart", dontStart ); // prevent images dragging in IE...
		}
	};
