            ...
            <div class="row">
                <div class="col-md-12 col-sm-12  ">
                    <div class="x_panel">
                        ...
                        <form id="demo-form2" data-parsley-validate="" action="{{route('admin_faq_update',['id'=>$data->id])}}" method="post" class="form-horizontal form-label-left" novalidate="" enctype="multipart/form-data">
                            @csrf
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Question<span class="required">*</span></label>
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="number" id="question" name="question" value="{{$data->question}}" required="required" class="form-control">
                                </div>
                            </div>
