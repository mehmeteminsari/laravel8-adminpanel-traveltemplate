        ...
        <div class="row">
            <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                    ...
                    <form id="demo-form2" data-parsley-validate="" action="{{route('admin_image_store',['product_id'=>$data->id])}}" method="post" class="form-horizontal form-label-left" novalidate="" enctype="multipart/form-data">
                        @csrf
                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($images as $rs)
                            <tr>
                                ...
                                <td><a href="{{route('admin_image_delete',['id' => $rs->id,'product_id'=>$data->id])}}" class="fa fa-trash fa-2x" onclick="return confirm('Are you sure?')"></a></td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
